...
static const double         DEFAULT_TORQUE_VEL_THRESH   = 0.2;      ///< threshold to consider the torque still (N*m/s)
...
{ 
    ...
    PARAM_ID_ZERO_VEL_THRESH,   PARAM_ID_VEL_EST_WIND_SIZE, PARAM_ID_FORGET_FACTOR,     
    PARAM_ID_JOINT_TO_MONITOR,  PARAM_ID_TORQUE_VEL_THRESH,
    /* Output parameters */
...
new ParamProxyBasic<double>("torque vel thr",       PARAM_ID_TORQUE_VEL_THRESH,     1,                  ParamBilatBounds<double>(0.,10.),       PARAM_IN_OUT,       &DEFAULT_TORQUE_VEL_THRESH,     "Torque derivative (N*m/sec) threshold to consider the torque still"), 
