...
Head_stabilization_task = 1.0
headTask   = ctrl.createFrameTask("head_task", rname+'.head', lgsm.Displacement(), "R", w=Head_stabilization_task, kp=1., pose_des=head_init )
...
pl.legend()
pl.savefig("results/03_touch_wall_5N_COM.pdf", bbox_inches='tight' )
...
pl.savefig("results/03_touch_wall_5N_force.pdf", bbox_inches='tight' )
