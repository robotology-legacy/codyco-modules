...
struct wholeBodyDynamicsSettings {
    ...
    3: Gravity gravity; /** If kinematicSource is FIXED_LINK, specify the gravity vector (in m/s^2) in the fixedFrame */
    4: double imuFilterCutoff; /** Cutoff frequency (in Hz) of the first order filter of the IMU */
    5: double forceTorqueFilterCutoff; /** Cutoff frequency(in Hz) of the first order filter of the F/T sensors */
    6: bool useJointVelocity; /** Use the joint velocity measurement if this is true, assume they are zero otherwise. */
    7: bool useJointAcceleration; /** Use the joint acceleration measurment if this is true, assume they are zero otherwise. */
}
