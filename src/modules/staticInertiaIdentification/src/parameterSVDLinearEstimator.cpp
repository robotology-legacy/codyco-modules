...
parameterSVDLinearEstimator::parameterSVDLinearEstimator(unsigned int nParam,
...
/*************************************************************************************************/
void parameterSVDLinearEstimator::feedSample(const MatrixXd &input, const VectorXd &output)
{
    bool res;
    /*
    ...
    */
    ...
    svd_A.compute(A, ComputeFullU | ComputeFullV);

    sampleCount++;
}

/*************************************************************************************************/
void parameterSVDLinearEstimator::feedSampleAndUpdate(const MatrixXd &input, const VectorXd &output)
{
...
/*************************************************************************************************/
/*
void parameterSVDLinearEstimator::predictOutput(const MatrixXd &input, VectorXd &output) const
{
...
/*************************************************************************************************/
void parameterSVDLinearEstimator::getParameterEstimate(VectorXd &xEst) const
{
...
/*************************************************************************************************/
const VectorXd & parameterSVDLinearEstimator::getParameterEstimate() const
{
    return x;
}
...
/*************************************************************************************************/
/*
void parameterSVDLinearEstimator::getCovarianceMatrix(MatrixXd &sigma) const
{
...
/*************************************************************************************************/
/*
void parameterSVDLinearEstimator::getParameterEstimate(VectorXd &xEst, MatrixXd &sigma) const
{
    assert(sigma.cols()==n && sigma.rows()==n);
...
/*************************************************************************************************/
void parameterSVDLinearEstimator::getEstimationState(MatrixXd &_A, VectorXd &bOut) const
{
...
/*************************************************************************************************/
void parameterSVDLinearEstimator::setEstimationState(const MatrixXd &Anew, const VectorXd &bNew)
{
...
/*************************************************************************************************/
void parameterSVDLinearEstimator::getOutputErrorStandardDeviation(Eigen::VectorXd &sigma_oe_output)
{
    sigma_oe_output = sigma_oe;
}

/*************************************************************************************************/
void parameterSVDLinearEstimator::setOutputErrorStandardDeviation(const Eigen::VectorXd &sigma_oe_input)
{
...
void parameterSVDLinearEstimator::updateParameterEstimate()
{
    if( sampleCount > 3*n )
    {
        x = svd_A.solve(b);
...
/*************************************************************************************************/
void parameterSVDLinearEstimator::resizeAllVariables(double lambda)
{
...
void parameterSVDLinearEstimator::getSingularValues(Eigen::VectorXd & singular_values)
{
    singular_values = svd_A.singularValues();
}

void parameterSVDLinearEstimator::getSingularVectors(Eigen::MatrixXd & singular_vectors)
{
    singular_vectors = svd_A.matrixV();
}


int parameterSVDLinearEstimator::getNrOfSamples()
{
    return sampleCount;
}
