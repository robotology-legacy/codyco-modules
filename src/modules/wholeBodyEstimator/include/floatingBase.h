...
namespace wholeBodyEstimator
{
    ...
    {
    private:
        yarpWbi::yarpWholeBodyModel     * m_robot;
    ...
    public:
        ...
        /**
         *  This method should instantiate the yarpWholeBodyModel and initialize it.
         *
         *  @return true if everything is successful.
         */
        bool configure( yarp::os::ResourceFinder &rf, MatrixWrapper::Matrix rot_from_ft_to_acc, wbi::iWholeBodySensors * wbs );
         ...
         */
        bool compute_Rot_from_floatingBase_to_world( MatrixWrapper::Matrix rot_from_world_to_sensor,
                                                     MatrixWrapper::Matrix &rot_from_floatingBase_to_world);
        
        
        /**
         *  Retrieves whole body interface options from the Resource Finder as well as the modle joints used to instantiate the yarpWholeBodyModel.
         *
         *  @param rf                      Resource finder as passed by the module.
         *  @param RobotDynamicModelJoints Robot model joints list (output).
         *  @param yarpWbiOptions          yarpWholeBodyModel options (output).
         *
