...
actionStruct::actionStruct() {
        for (int i = 0; i < 6; i++) actionStruct::q_left_leg[i] = actionStruct::q_right_leg[i] = 0.0;
...
bool actionClass::parseCommandLine2(char* command_line1, char* command_line2, int line)
{
