...
IF (MATRIX_LIB STREQUAL "eigen")
  IF ( NOT EIGEN_INCLUDE )
      MESSAGE("-- Finding Eigen path")
    FIND_PATH(EIGEN3_FOUND Eigen/Core)
    MESSAGE("-- Finding Eigen3 Package")
    FIND_PACKAGE(Eigen3)
    IF ( EIGEN3_FOUND )
      MESSAGE("-- Looking for Eigen3 - found")
      SET( EIGEN_INCLUDE "${EIGEN3_FOUND}")
      SET( MATRIX_LIBS "")
    ELSE ( EIGEN3_FOUND )
  ...
  SET( MATRIX_INCLUDE "${EIGEN3_INCLUDE_DIR}")
